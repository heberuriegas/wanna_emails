...
describe RecollectionsController do
  ...
  # Recollection. As you add validations to Recollection, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # RecollectionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested recollection as @recollection" do
      recollection = Recollection.create! valid_attributes
      get :show, {:id => recollection.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested recollection as @recollection" do
      recollection = Recollection.create! valid_attributes
      get :edit, {:id => recollection.to_param}, valid_session
      assigns(:recollection).should eq(recollection)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Recollection" do
        expect {
          post :create, {:recollection => valid_attributes}, valid_session
      ...
      it "redirects to the created recollection" do
        post :create, {:recollection => valid_attributes}, valid_session
        response.should redirect_to(Recollection.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved recollection as @recollection" do
        ...
        post :create, {:recollection => { "name" => "invalid value" }}, valid_session
        assigns(:recollection).should be_a_new(Recollection)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested recollection" do
        ...
        put :update, {:id => recollection.to_param, :recollection => { "name" => "MyString" }}, valid_session
      end

      it "assigns the requested recollection as @recollection" do
        recollection = Recollection.create! valid_attributes
        put :update, {:id => recollection.to_param, :recollection => valid_attributes}, valid_session
        assigns(:recollection).should eq(recollection)
      end
      ...
      it "redirects to the recollection" do
        recollection = Recollection.create! valid_attributes
        put :update, {:id => recollection.to_param, :recollection => valid_attributes}, valid_session
        response.should redirect_to(recollection)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the recollection as @recollection" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Recollection.any_instance.stub(:save).and_return(false)
        put :update, {:id => recollection.to_param, :recollection => { "name" => "invalid value" }}, valid_session
        assigns(:recollection).should eq(recollection)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested recollection" do
      recollection = Recollection.create! valid_attributes
      expect {
        delete :destroy, {:id => recollection.to_param}, valid_session
      }.to change(Recollection, :count).by(-1)
    end
    ...
    it "redirects to the recollections list" do
      recollection = Recollection.create! valid_attributes
      delete :destroy, {:id => recollection.to_param}, valid_session
      response.should redirect_to(recollections_url)
    end
  end
